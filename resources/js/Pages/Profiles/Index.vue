<template>
  <div>
    <Head :title="`My Profil`" />
    <div class="flex justify-start mb-8 max-w-3xl">
      <h1 class="mb-8 text-3xl font-bold">My Profiles</h1>
    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          <text-input v-model="form.id" :error="form.errors.id" class="pb-8 pr-6 w-full lg:w-1/2 hidden" label="Id" />
